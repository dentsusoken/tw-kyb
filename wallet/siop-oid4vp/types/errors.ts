export enum Errors {
  REQUEST_OBJECT_PASSBY_MUST_VALUE_OR_REFERENCE = 'Request object passBy must be REFERENCE or VALUE',
  NO_REFERENCE_URI = 'referenceUri must be set when REFERENCE is specified',
  NO_REQUEST = 'request(payload) must be set when VALUE is specified',
  NULLISH_SOURCE = 'source parameter must not be nullish',
